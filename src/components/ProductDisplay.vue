<template>
  <div :class="['content', renderClassByProductCategory(product?.category)]">
    ...
    <div
      v-else-if="product"
      :class="['product', renderClassByProductCategory(product.category)]"
    >
      ...
      <div class="product__content">
        ...
        <div class="product__header-flex">
          ...
          <div class="product__rating">
            ...
            <div class="star-rating">
              ...
              <div
                class="star-content star-content-fill"
        ...
        <div class="cta">
          ...
          <button @click="increaseProductIdHandler" class="btn btn-outline">
            Next product
          </button>
        </div>
      </div>
